...
awful.keyboard.append_global_keybindings({
  ...
  awful.key({ Global.Keys.ModKey }, "Enter", function()
    awful.spawn.once(Global.Apps.Terminal)
  ...
  ------------------------------------------------------------------------------
  -- tag navigation
  awful.key({ Global.Keys.ModKey }, "Tab", awful.tag.viewnext, { description = "view next tag", group = "tag-nav" }),
  awful.key({ Global.Keys.ModKey }, "l", awful.tag.viewnext, { description = "view next tag", group = "tag-nav" }),
  ...
  awful.key({ Global.Keys.ModKey }, "h", awful.tag.viewprev, { description = "view pevious tag", group = "tag-nav" }),
  ------------------------------------------------------------------------------
  -- tag controls
  ...
  end, { description = "window switcher (rofi)", group = "launcher" }),
